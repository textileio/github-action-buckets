...
export class GetSessionInfoReply extends jspb.Message {
  getKey(): Uint8Array | string;
  getKey_asU8(): Uint8Array;
  getKey_asB64(): string;
  setKey(value: Uint8Array | string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetSessionInfoReply.AsObject;
  static toObject(includeInstance: boolean, msg: GetSessionInfoReply): GetSessionInfoReply.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetSessionInfoReply, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetSessionInfoReply;
  static deserializeBinaryFromReader(message: GetSessionInfoReply, reader: jspb.BinaryReader): GetSessionInfoReply;
}

export namespace GetSessionInfoReply {
  export type AsObject = {
    key: Uint8Array | string,
    username: string,
    email: string,
...
export class DestroyAccountReply extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): DestroyAccountReply.AsObject;
  static toObject(includeInstance: boolean, msg: DestroyAccountReply): DestroyAccountReply.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: DestroyAccountReply, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): DestroyAccountReply;
  static deserializeBinaryFromReader(message: DestroyAccountReply, reader: jspb.BinaryReader): DestroyAccountReply;
}

export namespace DestroyAccountReply {
  export type AsObject = {
  }
}
