...
type APIDestroyAccount = {
  readonly methodName: string;
  readonly service: typeof API;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof hub_pb.DestroyAccountRequest;
  readonly responseType: typeof hub_pb.DestroyAccountReply;
};
...
export class API {
  ...
  static readonly DestroyAccount: APIDestroyAccount;
}
...
export class APIClient {
  ...
  destroyAccount(
    requestMessage: hub_pb.DestroyAccountRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: hub_pb.DestroyAccountReply|null) => void
  ): UnaryResponse;
  destroyAccount(
    requestMessage: hub_pb.DestroyAccountRequest,
    callback: (error: ServiceError|null, responseMessage: hub_pb.DestroyAccountReply|null) => void
