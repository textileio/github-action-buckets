...
API.DestroyAccount = {
  ...
  responseType: hub_pb.DestroyAccountReply
};
...
APIClient.prototype.destroyAccount = function destroyAccount(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(API.DestroyAccount, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
