...
goog.exportSymbol('proto.threads.pb.CollectionConfig.IndexConfig', null, global);
 ...
 * @constructor
 */
proto.threads.pb.CollectionConfig.IndexConfig = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.threads.pb.CollectionConfig.IndexConfig, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.threads.pb.CollectionConfig.IndexConfig.displayName = 'proto.threads.pb.CollectionConfig.IndexConfig';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.threads.pb.CollectionConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.threads.pb.CollectionConfig.IndexConfig.toObject, includeInstance)
  };
...
proto.threads.pb.CollectionConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.threads.pb.CollectionConfig.IndexConfig;
      reader.readMessage(value,proto.threads.pb.CollectionConfig.IndexConfig.deserializeBinaryFromReader);
...
proto.threads.pb.CollectionConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.threads.pb.CollectionConfig.IndexConfig.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.threads.pb.CollectionConfig.IndexConfig.prototype.toObject = function(opt_includeInstance) {
  return proto.threads.pb.CollectionConfig.IndexConfig.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.threads.pb.CollectionConfig.IndexConfig} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.threads.pb.CollectionConfig.IndexConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.threads.pb.CollectionConfig.IndexConfig}
 */
proto.threads.pb.CollectionConfig.IndexConfig.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.threads.pb.CollectionConfig.IndexConfig;
  return proto.threads.pb.CollectionConfig.IndexConfig.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.threads.pb.CollectionConfig.IndexConfig} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.threads.pb.CollectionConfig.IndexConfig}
 */
proto.threads.pb.CollectionConfig.IndexConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.threads.pb.CollectionConfig.IndexConfig.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.threads.pb.CollectionConfig.IndexConfig.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.threads.pb.CollectionConfig.IndexConfig} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.threads.pb.CollectionConfig.IndexConfig.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPath();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.threads.pb.CollectionConfig.IndexConfig.prototype.getPath = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.threads.pb.CollectionConfig.IndexConfig} returns this
 */
proto.threads.pb.CollectionConfig.IndexConfig.prototype.setPath = function(value) {
 ...
 * @return {boolean}
 */
proto.threads.pb.CollectionConfig.IndexConfig.prototype.getUnique = function() {
 ...
 * @return {!proto.threads.pb.CollectionConfig.IndexConfig} returns this
 */
proto.threads.pb.CollectionConfig.IndexConfig.prototype.setUnique = function(value) {
 ...
 * @return {!Array<!proto.threads.pb.CollectionConfig.IndexConfig>}
 */
proto.threads.pb.CollectionConfig.prototype.getIndexesList = function() {
  return /** @type{!Array<!proto.threads.pb.CollectionConfig.IndexConfig>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.threads.pb.CollectionConfig.IndexConfig, 3));
};


/**
 * @param {!Array<!proto.threads.pb.CollectionConfig.IndexConfig>} value
 * @return {!proto.threads.pb.CollectionConfig} returns this
*/
...
/**
 * @param {!proto.threads.pb.CollectionConfig.IndexConfig=} opt_value
 * @param {number=} opt_index
 * @return {!proto.threads.pb.CollectionConfig.IndexConfig}
 */
proto.threads.pb.CollectionConfig.prototype.addIndexes = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.threads.pb.CollectionConfig.IndexConfig, opt_index);
};
