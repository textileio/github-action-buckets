...
var compatData = _interopDefault(require('mdn-browser-compat-data'));
...
const ES2016_FEATURES = [...ES2015_FEATURES, "javascript.operators.arithmetic.exponentiation", "javascript.builtins.Array.includes"];
    ...
    versions.forEach(version => {
        ...
        if (start == null && end == null) {
            ...
            if (version === "TP") {
                ...
                shouldSet =
                    semver.gte(coerceToString(browser, version), coerceToString(browser, start)) &&
                        semver.lte(coerceToString(browser, version), coerceToString(browser, end));
            }
        }
        if (shouldSet) {
            corrections.push({
...
class UaParserWrapper {
    ...
    extendGetBrowserResult(result) {
        ...
        if (BOT_TO_USER_AGENTS_MAP.BingBot(this.userAgent) ||
                ...
                ? // If there are multiple entries, take the one that hasn't been removed yet, if any
                    (() => {
                        ...
                        return versionStillInBrowser == null || versionStillInBrowser.version_added == null
                            ? false
                            : versionStillInBrowser.version_added;
                    })()
