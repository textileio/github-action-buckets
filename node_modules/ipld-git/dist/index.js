...
const bs58 = __webpack_require__(22);
...
const multihashes = __webpack_require__(11);

const multihash = __webpack_require__(3);

const CID = __webpack_require__(6);

const strftime = __webpack_require__(57);
...
const CIDUtil = __webpack_require__(50);

const withIs = __webpack_require__(51);
/**
...
const utils_1 = __webpack_require__(59); // The default Buffer size if one is not provided.
...
const multihashing = __webpack_require__(20);

const CID = __webpack_require__(6);

const multicodec = __webpack_require__(52);

const gitUtil = __webpack_require__(5);

const commit = __webpack_require__(58);

const tag = __webpack_require__(60);

const tree = __webpack_require__(61);
...
exports.resolver = __webpack_require__(62);
...
const errcode = __webpack_require__(21);
...
var basex = __webpack_require__(10);
...
const sha3 = __webpack_require__(28);

const mur = __webpack_require__(31);

const sha = __webpack_require__(33);

const {
  fromNumberTo32BitBuf
} = __webpack_require__(34); // Note that although this function doesn't do any asynchronous work, we mark
...
module.exports = {
  ...
  addBlake: __webpack_require__(35)
};
...
(function () {
  ...
  var AMD =  true && __webpack_require__(30);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(29), __webpack_require__(9)))
...
const blake = __webpack_require__(36);
...
var b2b = __webpack_require__(37);

var b2s = __webpack_require__(38);
...
var util = __webpack_require__(12); // 64-bit unsigned addition
...
// Adapted from the reference implementation in RFC7693
// Ported to Javascript by DC - https://github.com/dcposch
var util = __webpack_require__(12); // Little-endian byte access.
...
const constants = __webpack_require__(40);
...
const Base = __webpack_require__(41);

const baseX = __webpack_require__(10);

const base16 = __webpack_require__(42);

const base32 = __webpack_require__(43);

const base64 = __webpack_require__(44); // name, code, implementation, alphabet
...
const intTable = __webpack_require__(46);
...
const varintEncode = __webpack_require__(13).varintEncode; // map for codecName -> codeVarintBuffer
...
const intTable = __webpack_require__(53);

const codecNameToCodeVarint = __webpack_require__(54);
...
exports.print = __webpack_require__(56);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(0).Buffer))
...
const varintEncode = __webpack_require__(14).varintEncode; // map for codecName -> codeVarintBuffer
...
const SmartBuffer = __webpack_require__(7).SmartBuffer;
...
exports.deserialize = data => {
      ...
      case 'mergetag':
        {
          ...
          const tag = {
            object: gitUtil.shaToCid(Buffer.from(mt[1], 'hex'))
          };
          const startLine = line;
  ...
  Object.defineProperty(res, 'gitType', {
    enumerable: false
  });
  return res;
};
